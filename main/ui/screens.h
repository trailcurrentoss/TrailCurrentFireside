...
typedef struct _objects_t {
    ...
    lv_obj_t *label_solar_power_wattage_value;
    lv_obj_t *panel_charge_type;
    lv_obj_t *label_charge_status_value_s;
    ...
    lv_obj_t *obj13;
    lv_obj_t *label_power_battery_percentage_value;
    ...
    lv_obj_t *panel_fresh_water;
    lv_obj_t *label_fresh_water_icon;
    lv_obj_t *label_fresh_water_text;
    lv_obj_t *bar_fresh_water_value;
    lv_obj_t *label_fresh_water_value;
    lv_obj_t *obj20;
    lv_obj_t *bar_grey_water_level;
    lv_obj_t *bar_black_water_level;
    lv_obj_t *obj21;
    lv_obj_t *obj22;
    lv_obj_t *obj23;
    ...
    lv_obj_t *label_temperature_readings_header;
    lv_obj_t *btn_temp_fahrenheit;
    lv_obj_t *lbl_temp_fahrenheit_icon;
    lv_obj_t *btn_temp_celsius;
    lv_obj_t *lbl_temp_celsius_icon;
    ...
    lv_obj_t *btn_reset_all_buttons;
    ...
    lv_obj_t *btn_edit_device_none;
    lv_obj_t *btn_edit_device_torrent;
    lv_obj_t *btn_edit_device_switchback;
    lv_obj_t *btn_edit_addr0;
    lv_obj_t *btn_edit_addr1;
    lv_obj_t *btn_edit_addr2;
    lv_obj_t *btn_edit_ch0;
    lv_obj_t *btn_edit_ch1;
    lv_obj_t *btn_edit_ch2;
    lv_obj_t *btn_edit_ch3;
    lv_obj_t *btn_edit_ch4;
    lv_obj_t *btn_edit_ch5;
    lv_obj_t *btn_edit_ch6;
    lv_obj_t *btn_edit_ch7;
    lv_obj_t *btn_button_edit_clear;
